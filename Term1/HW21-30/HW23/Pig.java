...
Clara Mohri, Wenting Li, Kevin Lin
APCS1 Pd8
Hw23 -- Etterbay Odingcay Oughthray Ollaborationcay
2017-10-25

- Moving the entire sequence that makes the leading consonant sound to the
  back + ay (That -> Atthay)
- Dealing with capital letters
- Punctuation
- The single word "a"
- Housekeep user input (clean up white space)
- Contractions (apostrophes in a word)
*/
